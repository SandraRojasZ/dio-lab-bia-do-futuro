...
PATRIMONO: R$ {perfil['patrimonio_total']} | RESERVA: R$ {perfil['reserva_emergencia_atual']}
...
#======================= SYSTEM PROMPT ==============================
SYSTEM_PROMPT = f"""Você é a Athena, uma educadora financeira amigável e didático.
